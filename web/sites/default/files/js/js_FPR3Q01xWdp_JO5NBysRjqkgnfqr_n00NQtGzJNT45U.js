...
const slider = ($) => {
  Drupal.behaviors.articleslider = {
    attach(context) {
      ...
      $context.find(".nav-link-recommended-conferences").click(function(){
        $context.find('.slider__one').slick({
          infinite: true,
          speed: 300,
          slidesToShow: 3,
...
//     attach(context) {
//       const $context = $(context);
//       $context.find('.homepagebanner-slider-caraousel').slick({
//         infinite: true,
//         speed: 400,
//         dots: true,
//         slidesToShow: 1,
